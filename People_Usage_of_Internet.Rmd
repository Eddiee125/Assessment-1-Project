...
```{r Grouping and Calculating Mean, echo=TRUE, fig.align='center'}

# Grouping the data by year and calculate the mean, min, and max number of internet users per year
...
# Creating a table by using kable with a caption

kable(latin_america_stats_per_year, 
